...
namespace SWP391.Project.Services
{
    ...
    public class ProductService : BaseService, IProductService
    {
        ...
        {
            ICollection<ProductEntity> productCollection = await _productRepository.GetCollectionAsync();
        ...
        public async Task<bool> UpdateProductQuantityAsync(Guid productId, UpdateProductQuantityDto input)
        {
            ...
            return await _inStockRepository.UpdateAsync(entity: productInStock);
        }
